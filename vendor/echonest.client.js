(function(window, $) {
    ...
    /**
     * Root class. This can be invoked multiple times if you want to connect to
     * the API with different options / keys.
     */
    function EchoNest(apiKey, options) {
        ...
        // Determines the templating engine and memoizes the function used to
        // find it.
        ...
        // TODO: This should use proxy objects, implement once more templating
        ...
        function toTemplate(template, data, options) {
            ...
            if (engineDetails.name === "jQuery") {
                ...
                // underscore templates don't support arrays, we must manually
                // loop over the array and construct html
        ...
        // used to flatten nested json and preserve structure via keyname, this
        // allows easy access to nested JSON values in jQuery templates
            ...
            for (var k in obj) {
                if (includePrototype || obj.hasOwnProperty(k)) {
                    ...
                    if (prop
                        ...
                        flatten_json(prop, includePrototype, into, prefix + k
                                        + "_");
                    } else {
                        into[prefix + k] = prop;
                    }
        ...
        if (!apiKey) {
            throw new Error('You must supply an API key to use the API!');
        }
        ...
        /**
         * Used to handle a response back from the api. Will throw errors if a
         * problem is detected.
         */
            ...
            this.settings = function(options) {
                ...
                return {
                    ...
                    success : function(data, textStatus, XMLHttpRequest) {
                        if (options.success) {
                            options.success(new Response(data))
                        }
                    }
                }
            }
        ...
        AudioCollection.prototype = new Collection();
        AudioCollection.prototype.constructor = AudioCollection;

        /**
         * Used to interact with a collection of blogs Inherits from Collection
         */
        var BlogCollection = function(data) {
            this.data = data;
            this.name = "blogs";
        };
        BlogCollection.prototype = new Collection();
        BlogCollection.prototype.constructor = BlogCollection;

        /**
         * Used to interact with a collection of biographies Inherits from
         * Collection
         */
        var BiographyCollection = function(data) {
            ...
            // flatten the json so we have access to nested items from inside
            // the template
        ...
        BiographyCollection.prototype = new Collection();
        BiographyCollection.prototype.constructor = BiographyCollection;

        /**
         * Familiarity information about an artist Inherits from Singular
         */
        var Familiarity = function(data) {
            this.data = data;
            this.name = "artist";
        };
        Familiarity.prototype = new Singular();
        Familiarity.prototype.constructor = Familiarity;

        /**
         * Hotttnesss information about an artist Inherits from Singular
         */
        var Hotttnesss = function(data) {
            this.data = data;
            this.name = "artist";
        };
        Hotttnesss.prototype = new Singular();
        Hotttnesss.prototype.constructor = Hotttnesss;
        ...
        NewsCollection.prototype = new Collection();
        NewsCollection.prototype.constructor = NewsCollection;

        /**
         * Profile information about an artist Inherits from Singular
         */
        var Profile = function(data) {
            this.data = data;
            this.name = "artist";
                // this.data[this.name] = flatten_json(this.data[this.name]); //
                // this should need flattening but endpoint doesn't seem to be
                // returning all results??
            };
        Profile.prototype = new Singular();
        Profile.prototype.constructor = Profile;

        /**
         * Used to interact with a collection of reviews Inherits from
         * Collection
         */
        ...
        ReviewsCollection.prototype = new Collection();
        ReviewsCollection.prototype.constructor = ReviewsCollection;
        ...
        SearchResultsCollection.prototype = new Collection();
        SearchResultsCollection.prototype.constructor = SearchResultsCollection;

        /**
         * Used to interact with a collection of songs Inherits from Collection
         */
        var SongsCollection = function(data) {
            this.data = data;
            this.name = "songs";
        };
        SongsCollection.prototype = new Collection();
        SongsCollection.prototype.constructor = SongsCollection;

        /**
         * Used to interact with a collection of artist similar to the one
         * specified Inherits from Collection
         */
        ...
        SimilarCollection.prototype = new Collection();
        SimilarCollection.prototype.constructor = SimilarCollection;

        /**
         * Used to interact with a collection of terms Inherits from Collection
         */
        var TermsCollection = function(data) {
            this.data = data;
            this.name = "terms";
        };
        TermsCollection.prototype = new Collection();
        TermsCollection.prototype.constructor = TermsCollection;

        /**
         * Used to interact with a collection of hottt artists Inherits from
         * Collection
         */
        ...
        TopHotttCollection.prototype = new Collection();
        TopHotttCollection.prototype.constructor = TopHotttCollection;

        /**
         * Used to interact with a collection of top terms Inherits from
         * Collection
         */
        ...
        TopTermsCollection.prototype = new Collection();
        TopTermsCollection.prototype.constructor = TopTermsCollection;

        /**
         * Used to interact with a collection of URLs for an artist Inherits
         * from Collection
         */
        ...
        UrlsCollection.prototype = new Collection();
        UrlsCollection.prototype.constructor = UrlsCollection;

        /**
         * Used to interact with a collection of videos for an artist Inherits
         * from Collection
         */
        ...
        VideoCollection.prototype = new Collection();
        VideoCollection.prototype.constructor = VideoCollection;
